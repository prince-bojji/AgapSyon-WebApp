  ...
  return (
    <div>
      <div className='flex justify-between items-center pb-2'>
        ...
        <button
          className={`flex text-3xl lg:hidden transition duration-500 ${
            isOpen && 'rotate-180'
          }`}
...
const Footer = () => {
  ...
  return (
    <footer className='flex flex-col lg:flex-row justify-evenly py-12 px-5 bg-[#a8c9df] font-montserrat text-[#5d7468] text-[0.725rem]'>
      <div
        className='px-20 pt-3 lg:pt-0 m-auto lg:m-0 w-fit text-center order-1 lg:-order-1'
        onClick={() => navigate('/Home')}>
        <img
          src={logo}
          className='m-auto w-36 max-w-full h-auto pb-5 cursor-pointer'
        />
      ...
      <Collapsible title='Support'>
        0912 223 7127
        <br />
        126 Salvador St. Baesa Caloocan City
        <br />
