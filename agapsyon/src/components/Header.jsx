...
const MenuItem = (props) => {
  ...
  return (
    <Link to={props.link}>
      <li className={`border-0 px-5 py-2 my-2 rounded-xl transition-all
...
const Header = () => {
    ...
    >
        <nav className='flex flex-wrap justify-between items-center px-4 py-4'>
            ...
            <div className={`lg:hidden w-6 flex flex-col gap-1 justify-center cursor-pointer text-4xl text-[#5d7468]
                ${isOpen && ' [&>*:nth-child(1)]:translate-y-[7.25px] [&>*:nth-child(1)]:rotate-45 [&>*:nth-child(2)]:opacity-0 [&>*:nth-child(3)]:-translate-y-[7.25px] [&>*:nth-child(3)]:-rotate-45'}`} 
