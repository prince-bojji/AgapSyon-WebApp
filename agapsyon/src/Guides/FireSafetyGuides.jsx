      ...
      <main className='p-4 md:p-8'>
        <section>
          ...
          <ul className='list-disc list-inside'>
            <li>
              Install smoke detectors on every floor of your home and test them
              regularly.
            </li>
        ...
        <section className='mt-8'>
          ...
          <ul className='list-disc list-inside'>
            <li>
              If a fire occurs, evacuate the building immediately and call
              emergency services.
            </li>
            <li>
              Crawl low under smoke to escape to safety, as smoke rises and can
              be toxic.
            </li>
            <li>
              Feel doors before opening them; if they are hot, do not open and
        ...
        <section className='mt-8'>
          ...
          <ul className='list-disc list-inside'>
            <li>
              Only attempt to use a fire extinguisher if the fire is small and
              contained.
            </li>
            <li>
              Remember the PASS method: Pull the pin, Aim at the base of the
              fire, Squeeze the handle, and Sweep from side to side.
            </li>
            <li>
              If the fire is spreading rapidly or too large to control, evacuate
              immediately.
            </li>
          </ul>
        </section>
