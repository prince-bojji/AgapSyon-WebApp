      ...
      <div className='w-full md:w-2/5 h-full flex flex-col items-center p-10 drop-shadow-lg z-10 bg-gradient-to-r from-[#FFEDCC] to-[#BFCFFF]'>
        ...
        <div className='flex flex-col justify-center items-center space-y-0 mt-auto mb-auto'>
          <div className='flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 mt-10'>
            <button
              className='w-[200px] h-[70px] px-5 bg-blue-500 text-white rounded-lg shadow-md hover:bg-blue-700 m-0'
              onClick={() => navigate('/UserLogin')}>
              User
            </button>
            <button
              className='w-[200px] h-[70px] px-5 bg-green-500 text-white rounded-lg shadow-md hover:bg-green-700 m-0'
